...
class SnakeLogger:
    def __init__(self, text_browser: QTextBrowser, max_logs=20, buffer_size=50, update_interval=100):
    ...
    def _trim_logs(self):
        ...
        if block_count > self.max_logs:
            ...
            cursor.movePosition(cursor.Down, cursor.KeepAnchor, block_count - self.max_logs)
